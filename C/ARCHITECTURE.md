...
| **Tests** | Unit tests | `tests/test_*.c` | 232, 270/0/0 |
...
- **Registry:** 84 registered tools, auto-discovered at init time
...
## Testing
- **234 test files, 270/0/0 suite** (all passed, 0 failed, 0 skipped)
