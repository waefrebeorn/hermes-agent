...
| F10 | F10 stdin/stdout safe guard reclassified PORTED. install_safe_stdio() at main.c:25 calls signal(SIGPIPE, SIG_IGN) at startup — already implemented. Battleship claim was stale. | main.c:25 install_safe_stdio() — signal(SIGPIPE, SIG_IGN). |
Suite: 326/0/0 (283 test files). Gaps: 103. v284
