...
- Phase 37: Suppressed unused-function/param/variable warnings across 7 files
  ...
  Suite 283/0/0, commits 80a4dc334, b1bfb81b4, 3940341af pushed. Battleship v33 (21→19 gaps). W11 browser UB fixed, W13 missing headers fixed.

## Critical Gaps
- **P0**: Form-vs-function (2 gaps) — Python hook, test cheating
- **P1**: Pipeline, cross-comparison, real warning bugs (11 gaps)
