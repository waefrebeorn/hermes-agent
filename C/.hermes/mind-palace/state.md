...
- **Active:** battleship-v8 (147 verified gaps across 22 sectors)
...
|------|----|-------------|-----|--------|
| 1 | D22 | Feishu doc/drive tool support | 150 | S7 |
| 2 | N02 | Mixture of Agents tool | 300 | S20 |
| 3 | U01 | TUI image display (sixel/kitty/iterm2) — code exists but unwired | 150 | S14 |
| 4 | U02 | TUI session browser with search | 200 | S14 |
| 5 | T04-T25 | Test coverage for remaining untested modules | — | S12 |
| 6 | N03 | Feishu doc and drive tools | 250 | S20 |
| 7 | U04 | TUI config editor | 150 | S14 |
| 8 | U03 | Skill browser/list | 100 | S14 |
| 9 | U05 | Plugin manager | 100 | S14 |
| 10 | U06 | Gateway status dashboard | 120 | S14 |
