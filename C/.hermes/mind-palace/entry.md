...
Phase 272: S8 R02+R10 depth — batch 5 functions. bedrock_convert_tools_to_converse() (OpenAI→Converse tool format), estimate_tokens_rough(), provider_resolve_requests_verify() (HERMES_VERIFY_SSL), provider_extract_context_length(), provider_extract_max_completion_tokens() (nested JSON extraction from model metadata). 54 new assertions. 94 gaps remain.
