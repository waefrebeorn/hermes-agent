...
Libs:    59      (lib/*/)
Gaps:    ~362    (items across 11 phases, battleship-v16 Triple DA)
|Parity:  item-level (~362 items — see battleship-v16)
```
...
- **Battleship:** `battleship-v16.md` (~362 items across 11 phases)
