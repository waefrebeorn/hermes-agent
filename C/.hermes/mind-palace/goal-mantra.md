...
**168 sector gaps** across 14 sectors (battleship-v12). 85 tools, 118 commands.

## Phase Order
1. Phase 0b: 12 display/visual gaps remaining (V10 ✅ markdown — V21 NO_COLOR ✅, V11 multi-spinner ✅ → V20 output helpers)
...
|Missing: inline diffs, dynamic banner stats, multi-spinner types, multi-line input, rich errors, working TUI, Python TUI ecosystem, voice mode, /recap, tips, NO_COLOR, output helpers.
