     ...
     5|
     6|## State
     7|357 gaps across 20 sectors (battleship-v10). 85 tools, 79 CLI, 19 gateways.
     8|Suite 226/0/23. Binary 30MB.
     9|
    10|## Phase Order
    11|    12|1. Phase 0b: 12 display/visual parity (make it look the same)
