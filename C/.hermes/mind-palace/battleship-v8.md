...
## SECTOR 14: TUI Depth (7 gaps)

C tui_fullscreen.c (~3800 lines) vs Python TUI (Ink/React, ~5000 lines).

| # | ID | Feature | LOC | Priority |
|---|-----|---------|-----|----------|
| 1 | U02 | Session browser with search | 200 | P2 |
| 2 | U03 | Skill browser/list | 100 | P2 |
| 3 | U04 | Config editor | 150 | P2 |
| 4 | U05 | Plugin manager | 100 | P3 |
| 5 | U06 | Gateway status dashboard | 120 | P2 |
| 6 | U07 | Cron job viewer | 80 | P2 |
| 7 | U08 | Log viewer (tail -f in TUI) | 100 | P2 |
