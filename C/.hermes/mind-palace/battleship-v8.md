...
Total: **219 active gaps** across 22 sectors (resolved items retired to vault Phase 10+).
...
## SECTOR 11: Bug Fixes & Known Issues (3 gaps)
...
| 3 | B16 | OOM not handled in `db_list_with_meta` loop | db.c:522 (calloc NULL check) | 5 | P3 |
