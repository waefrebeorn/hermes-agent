...
216+ gaps (battleship v34 across 10 sectors). Fork diverged — C/ lives only on fork; upstream removed C/.
...
L03 done (vision auto-disable). 14 real + 5 partial S1 gaps remain. D09 partial (multi-line via Alt+Enter). The 14 display features are all implemented.
