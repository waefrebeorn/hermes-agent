...
Phase 216: L26 hermes_message_sanitize() — sanitization pipeline (surrogate fix, think-block strip, secret redaction). Wired into agent_loop.c. 35 tests. 107→106 gaps. S1 L26 PORTED.
