     1|# Slermes C — Overnight Map (v6 — 357 Gaps)
     2|
     3|## Navigation
     4|- **Battleship:** battleship-v10.md — 357 gaps, 20 sectors
    ...
    10|
    11|## Phase 0b (12) — Display
    12|V01 skin engine → V02 spinner → V03 banner → V04 status bar → V05 tool feed → V06 response box → V07 help → V08 256-color → V09 prompt → V10 markdown → V11 faces → V12 emoji
    13|
