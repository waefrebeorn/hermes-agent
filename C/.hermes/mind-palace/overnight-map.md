...
Suite 294/0/0 (248 test files). Phase 65: upstream header capture (cf-ray, x-openrouter-*, x-request-id) wired into non-streaming LLM path. Structured stream error logging. Phase 64: error_classify() wired. S2 stale sweep: A15 retired.
