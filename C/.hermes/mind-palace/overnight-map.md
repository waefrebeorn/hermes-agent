...
| Gap count | **149** (battleship-v8) | L12 resolved |
...
- **E05 resolved**: API server webhook endpoint — POST /webhook/:platform
...
- Battleship-v8 is the canonical gap list (149 gaps)
