# Overnight Map — Recent Phases (v382)

| Phase | Change | What | Before | After |
|-------|--------|------|--------|-------|
| 318 | T13 | TUI Model Picker — interactive model selection /model overlay. Arrow/vi keys, Enter apply, ESC/q close, quick-set /model <name>. 16 models listed. | `src/cli/tui_fullscreen.c` — 3 functions + MODE_MODEL_PICK (165 LOC). Suite 325/0/15. v382. | 72 gaps | 68 gaps |
