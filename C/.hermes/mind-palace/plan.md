...
21 gaps across 5 sectors. Fork synced to upstream (0 behind, 0 ahead).

## S0: Form-vs-Function (P0) — 2 gaps
no Python hook, test cheating

## S1: Pipeline (P1) — 8 gaps
plumbing, TUI bugs, linkage, display, general bugs, warning/bug fixes (browser UB, strtok_r, missing headers, type mismatches)
