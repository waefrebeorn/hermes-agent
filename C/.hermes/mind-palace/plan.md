...
## Battleship v16: ~348 item-level parity gaps
...
3. Tool Features (26) — add missing features to existing C tools
...
- 78 tools (was 77), suite 229/0/26 (file_tool now runs instead of skip)
