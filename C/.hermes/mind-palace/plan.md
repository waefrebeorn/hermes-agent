# Plan — Next Phase (v336)

S0+S1+S3+S6 PORTED. L24+L25+L26+L27+L28 PORTED. F10 PORTED. S8 R01+R10+R04 PARTIAL, R03+R05-R09 WON'T PORT. 94 gaps.
...
| P1 | S8 R04 | Gemini depth | translate_tool_choice + normalize_thinking_config done (Phase 269). R04 PORTED — all 6 portable functions implemented. |
