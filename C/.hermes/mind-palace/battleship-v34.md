...
**S5: 15 gaps (1 P1, 6 P2, 8 P3) — C01+C02+C04+C05+C06+C07+C08+C09+C13+C14+C15+C16 PORTED. C10+C12 WON'T PORT. C11 PARTIAL.**
...
| **TOTAL** | **75** | **4** | **31** | **29** | **21** | **S0+S1+S3+S6+S8+R02+R04+R10 all PORTED. S5 19→15 (C01+C13+C15+C16 PORTED). Suite 325/0/15.** |
