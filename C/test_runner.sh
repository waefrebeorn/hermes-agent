...
run_lib_test "logger" "tests/test_logger.c" "include" "-I$CDIR/lib/libplugin $CDIR/src/agent/logger.c -lpthread -Wl,--unresolved-symbols=ignore-all -Wno-error=format-truncation"
...
if gcc -O2 -Wall -Wextra -I"$CDIR/include" -I"$CDIR/lib/libjson" -I"$CDIR/lib/libhttp" -I"$CDIR/lib/libplugin" -I"$CDIR/lib/libbase64" -I"$CDIR/lib/libcrypto" \
    "$CDIR/tests/test_web.c" \
    "$CDIR/src/tools/web.c" "$CDIR/src/tools/tool_config.c" "$CDIR/src/tools/registry.c" \
    "$CDIR/lib/libhttp/http.c" "$CDIR/lib/libjson/json.c" "$CDIR/lib/libbase64/base64.c" "$CDIR/lib/libcrypto/crypto.c" "$CDIR/src/agent/vault.c" \
