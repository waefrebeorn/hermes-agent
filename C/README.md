...
**Canonical README lives here at `C/README.md`. Root `README.md` is a symlink to this file.**
...
```
hermes-agent/                   # Repo root (README -> C/README.md)
├── C/                          # All source code — this directory
│   ├── src/                    #   75.5K LOC
...
└── README.md -> C/README.md    # Symlink — edit C/README.md, not root
```

## Roadmap

500 gaps across 19 sectors tracked in `.hermes/mind-palace/plans/battleship-v2.md` within the `C/` directory:
