...
|----------|--------|-----|--------|
| P1 | S4 TUI | T11 thinking indicator | Animated spinner done (Phase 362). Remaining: agent overlay (T14), todo panel (T15), agents overlay (T14). |
| P1 | S5 C11 | Auth CLI | Remaining: xAI callback flow. |

**Structural gaps remaining by sector:**
- S4 TUI: 20 gaps (P1: T01-T08, T11, T14, T18; P2-P3: rest) — T09+T10 PORTED
