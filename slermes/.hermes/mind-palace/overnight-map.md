...
|-------|--------|------|--------|-------|
| 329 | X09 | Token exchange edge case expansion — 9 new assertions (7→16). auth_store_free single/multi/zero-count, oauth_token_free partial/empty/long fields. | `tests/test_token_exchange.c` — 9 new assertions (7→16). `test_runner.sh` — count 7→16. Suite 325/0/14. v386. | 68 gaps | 68 gaps |
