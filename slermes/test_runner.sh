...
if gcc -O2 -Wall -Wextra -I"$CDIR/include" -I"$CDIR/lib/libjson" -I"$CDIR/lib/libplugin" \
    ...
    if /tmp/hermes_test_tool_init > /dev/null 2>&1; then ok "tool_init (18 tests)"
...
if gcc -O2 -Wall -Wextra "$CDIR/tests/test_provider_openrouter.c" \
    ...
    if /tmp/hermes_test_provider_openrouter > /dev/null 2>&1; then
        ok "provider_openrouter (94 tests)"
...
if gcc -O2 -Wall -Wextra -I"$CDIR/include" -I"$CDIR/lib/libjson" -I"$CDIR/lib/libplugin" \
    ...
    if /tmp/hermes_test_exec_code > /dev/null 2>&1; then ok "exec_code_tool (21 tests)"
...
if gcc -O2 -Wall -Wextra "${INCLUDES_ALL[@]}" \
    ...
    if /tmp/hermes_test_x_search > /dev/null 2>&1; then ok "x_search (24 tests: 4 error-path + 5 date validation + 15 edge cases)"
...
if gcc -O2 -Wall -Wextra -I"$CDIR/include" -I"$CDIR/lib/libjson" -I"$CDIR/lib/libplugin" \
    ...
    if [ $? -eq 0 ]; then ok "todo_tool (23 tests)"
...
if gcc -O2 -Wall -Wextra -I"$CDIR/include" -I"$CDIR/lib/libjson" -I"$CDIR/lib/libplugin" \
    ...
    if SLERMES_HOME=/tmp/hermes_test_proc /tmp/hermes_test_process > /dev/null 2>&1; then ok "process_tool (34 tests)"
...
if gcc -O2 -Wall -Wextra -I"$CDIR/include" -I"$CDIR/lib/libjson" -I"$CDIR/lib/libplugin" -I"$CDIR/lib/libcron" \
    ...
    if /tmp/hermes_test_cron > /dev/null 2>&1; then ok "cron_tool (57 tests)"
...
if gcc -O2 -Wall -Wextra "${INCLUDES_ALL[@]}" \
    ...
    if /tmp/hermes_test_file_merge > /dev/null 2>&1; then ok "file_merge (13 tests)"
